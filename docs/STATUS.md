...
- 本轮功能提交 `7d21738` 已完成；本地证据覆盖 633/633 全量单测、9/9 FAQ 专项、5/5 图表测试、75 个生成页面/资源、35/35 应用测试、206.2 秒完整发布总门、生产依赖审计 0 漏洞、插件 3/3 SHA-256 和真实浏览器点击/键盘/320 px/打印预览；归档提交、推送与生产证据待本轮收敛后回写；
- 自动交付：待 `7d21738` 与本归档推送后，轮询 `/studio/faq-editor.mjs` 并运行稳定生产 smoke；本轮没有改变公开内容集合或结构化端点正文，因此不重置既有生产预算基线；
