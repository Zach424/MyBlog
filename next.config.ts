  ...
  return {
    ...
    async headers() {
      return [
        ...
        { source: "/posts", headers: [contentCacheHeader] },
        { source: "/posts/:slug", headers: [contentCacheHeader] },
        { source: "/projects", headers: [contentCacheHeader] },
        { source: "/projects/:slug", headers: [contentCacheHeader] },
        { source: "/series", headers: [contentCacheHeader] },
        { source: "/series/:slug", headers: [contentCacheHeader] },
